...
public class Deer extends HerbivorAnimal implements Runnable {
    ...
    public Deer(String title, int movementSpeed, boolean sex, Location location) {
        this.title = title;
    ...
    public static void getStatistic() {
        System.out.println("************************************************");
        System.out.println("Умерло или было съедено " + wasEaten + " оленей");
        System.out.println("Олени съели " + eatenHerbal + " кг растений");
        System.out.println("Было рождено " + wasReproduced + " оленят");
        System.out.println("Сменили локацию  " + wasRelocated + " оленей");
